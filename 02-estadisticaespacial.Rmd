...
La estimación del variograma espacio-temporal puede ser la generalización de la estimación de un proceso espacial. Es así que, sea $Z(s,t)$ un proceso intrinsecamente estacionario sobre un conjunto de $n$ ubicaciones espacio-temporales $\{(s_1,t_1),...,(s_n.t_n)\}$. 
Usualmente se utilizan dos alternativas para estimar el semivariograma $\gamma(.,.)$  utilizando los valores observados: 
